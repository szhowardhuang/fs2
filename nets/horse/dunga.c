...
void create()
{
set_name(HIW"九天仙龙"NOR, ({ "god dragon","dragon" }) );
...
int do_ascend()
{
        ...
        if (name != "dunga")
           return notify_fail("你不是这座骑的主人(dunga)无法骑他!!!\n");
...
message_vision("只见云雾慢慢散去,天空降下一道佛光,$N沐浴在佛光下,不知觉的已驾驭着"+this_object()->name()+"。\n",me);
...
message_vision("$N双手合十 嘴中念着梵语,只见"+this_object()->name()+"渐渐隐没于云雾中。\n",me);
