...
//Ôö¼Ó¼ÇÂ¼Íæ¼ÒµÄËÀÍö£¬ÒÔÃâÃ¿´Î¶¼ÓÐÈËËµÊÇÄªÃûÆäÃîµÄËÀÁË by bss
void start_death(object ob)
{
        ...
        if(ob->query_temp("last_damage_from"))
        {
                ...
                str=ob->query("name")+"±»"+fighter->query("name")+"ËùÉ±ÔÚ"+ctime(time())+"\n";
