...
void create()
{
        ...
        set_temp("apply/attack", 95);
        set("force_factor",10);
        set("bellicosity",1600);
        set("max_sen",2000);
        set("sen",2000);
        set("max_atman",1500);
        set("atman",1500);
...
"          －－ "HIW"冥  殿  "HIR"绝  "HIY"学  "HIB"第  一  式 －－"NOR"
 ...
 "HIW"身影中夹带着沉重的掌劲向你罩下,你正在迟疑之际已被无数掌影所击中!"NOR"
        "HIB"－－ "HIW"冥  殿  "HIR"绝  "HIY"学  "HIB"之  "HIC"终  "RED"极  "MAG"秘  "HIW"技 "HIB"－－"NOR"
          ...
          "HIW"七煞瘟神重重的掌,连叠的拳,万钧之力,浑雄之气,煞"NOR"
