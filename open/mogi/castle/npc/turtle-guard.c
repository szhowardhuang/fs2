...
void create() {
	...
	set_name("玄武守卫",({"turtle guard","guard"}));
	set("long",
	    "\n他是厉害妖魔。\n");
...
{
return notify_fail("玄武守卫说道 : 我没空陪你玩。\n");
}
...
{    
	...
	j=random(6000);
	  ...
	  {      
	  new("/open/sky/obj7/turtle_order")->move(environment(winner));
	  message_vision(HIM"\n从玄武守卫的身上掉下了一件奇怪的东西!!\n"NOR,winner);
          write_file("/log/sky/turtle_order",sprintf("%s(%s) 让玄武守卫掉下了玄武结令于 %s\n",
