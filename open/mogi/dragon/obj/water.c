...
{
      message_vision(HIB+"水龙背后掀起了一阵涛天的巨浪 ,正朝着$N迅速狂卷而去!!\n"+NOR,enemy[i]);
      message_vision(HIC+"$N闪躲不及 ,被汹涌的波涛卷得奄奄一息。\n"+NOR,enemy[i]);
  ...
  COMBAT_D->report_status(enemy[i], 1);
      ...
      message_vision(HIB+"水龙的背后掀起了一阵涛天的巨浪 ,正朝着$N迅速狂卷而去!!\n"+NOR,enemy[i]);
     message_vision(HIW+"只见$N飞身侧闪 ,轻轻避开水龙的攻击...\n"+NOR,enemy[i]);
