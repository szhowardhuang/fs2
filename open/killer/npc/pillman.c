...
// 2001.11.07 为了有关柴荣的心灵探索部分，追加新的资料
#include <ansi.h>
#include </open/open.h>
inherit NPC;
inherit SSERVER;
...
message_vision("一股气劲由"+this_player()->name()+"窜出",ob);
...
message_vision(HBRED+HIY"$N施展秘法, 吸走了$n身上的内力,法力与灵力!!!\n"NOR,this_object(),this_player());
...
string ask_his()
{
 ...
 message_vision(HIY"你们...想不到...呀.....居然可以探查到如此地步\n"NOR,me);
 message_vision(HIY"好吧...到此再隐瞒也没意义了，既然你都已经知道分功化影身法\n"NOR,me);
 message_vision(HIY"虽然此身法的真相连我也不清楚，因为当年柴荣逃出魔教的时候\n"NOR,me);
 message_vision(HIY"似乎在逃亡过程中经历了不少事情，不过却从来不愿意提起这一件事情\n"NOR,me);
 message_vision(HIY"小叶他似乎仅是接触到他逃亡的最后一段历程而救了他....\n"NOR,me);
 message_vision(HIY"小叶虽然看过他施展一种号称分功化影的身法，但是柴荣却不愿承认
\n"NOR,me);
 message_vision(HIY"因此真相连我也不清楚，但是婆婆可有一招密招 ‘心灵探索’\n"NOR,me);
 message_vision(HIY"或许你们可以利用(心灵探索)来探索有关柴荣的一些往事...\n"NOR,me);
...
string ask_discov()
{
 ...
 message_vision(HIY"既然你想要尝试心灵探索，就让婆婆来帮助你.....\n"NOR,me);
 message_vision(HIY"你会仿佛进入时光隧道一般，进入柴荣十几年前的往事......\n"NOR,me);
 message_vision(HIY"要注意，那是一种真实的精神空间，并非单只柴荣所知\n"NOR,me);
 message_vision(HIY"而是货真价实的回到当时的时空背景中........\n"NOR,me);
 message_vision(HIY"你的一举一动会并无法影响已存在的事实，但是毕竟你身处当时\n"NOR,me);
 message_vision(HIY"却有可能增加事实的存在，而且错误的决定，可能造成严重后果\n"NOR,me);
 message_vision(HIY"闭上你的眼睛吧.......让我来施展密法吧..............\n"NOR,me);
