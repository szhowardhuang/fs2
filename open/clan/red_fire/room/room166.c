inherit ROOM;
void create() {
	set( "short", "$HIC$【$HIM$大饭店 $HIR$VIP $HIY$走廊$HIW$五楼$HIC$】$NOR$" );
	set( "light_up", 1 );
	set( "exits", ([
...
，难怪$HIR$爱玫$NOR$教主说这是引进未来最新的$HIR$建$HIG$筑$HIY$科$HIC$技$NOR$所完成的高级住宅区；走
廊底就是红莲招待贵宾的特区，哈哈....前面还有$HIY$电梯$NOR$可以搭乘耶！
